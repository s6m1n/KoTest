package study.coroutines.coroutineScope
...
class CoroutineScopeTest {
    ...
    fun `Job을 명시하지 않으면 새로운 독립 Job이 생성된다`() {
        runBlocking {
            ...
            // then 1 : 내부에서 새로운 Job을 만들며 구조화된 동시성이 깨진다
            coroutineContext[Job]!! shouldNotBe scope.coroutineContext[Job]!!
            coroutineContext[Job]!!.children shouldNotContain scope.coroutineContext[Job]!!
